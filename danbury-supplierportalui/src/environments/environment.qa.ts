...
export const environment = {
    ...
    oktaUrl: 'https://cartuspoc.okta.com',
    oktaRedirectUri: 'https://d1xjfu45o7q524.cloudfront.net/',
    ...
    URL_LOGSTASH: 'https://car-alpha-logstash-tst01-1855885244.us-west-2.elb.amazonaws.com/'
};
/*
